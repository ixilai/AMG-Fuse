...
class L_color2(nn.Module):
    """Color consistency loss in YCbCr space."""
    def __init__(self):
...
class fusion_loss_vif(nn.Module):
    """Combined fusion loss for VI-IR image fusion."""
    ...
    def forward(self, image_RGB, image_B, image_fused_RGB):
        """
        Args:
            image_RGB: Clean visible (VI) RGB image
            image_B: Clean infrared (IR) single-channel image
            image_fused_RGB: Fused RGB output
        """
